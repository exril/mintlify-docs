...
<AccordionGroup>
  <Accordion icon="github" title="Clone your docs locally">
    ...
    [dashboard](https://dashboard.gravebot.xyz). To clone the repository
...
<Accordion icon="message-bot" title="Install our Github app">
  ...
  your [dashboard](https://dashboard.gravebot.xyz). Once the bot has been
...
<Accordion icon="rocket" title="Push your changes">
  ...
  update your docs through our [dashboard](https://dashboard.gravebot.xyz).
</Accordion>
